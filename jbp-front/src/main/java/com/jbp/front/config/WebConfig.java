...
public class WebConfig implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		registry.addInterceptor(frontTokenInterceptor()).addPathPatterns("/api/front/**").addPathPatterns("/api/publicly/**")
				...
				.excludePathPatterns("/api/front/login/mobile/register")
				.excludePathPatterns("/api/front/login/mobile/password")
				.excludePathPatterns("/api/front/login/mobile/account")
				...
				.excludePathPatterns("/api/front/login/forgot/password")
				.excludePathPatterns("/api/front/login/check/account")
