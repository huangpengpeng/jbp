...
public class UserWhiteController {
    ...
    public CommonResult<CommonPage<UserWhite>> getList(@ModelAttribute @Validated UserWhiteRequest request, @ModelAttribute PageParamRequest pageParamRequest) {
        return CommonResult.success(CommonPage.restPage(userWhiteService.pageList(request, pageParamRequest)));
    }

    @PostMapping("/add")
    @ApiOperation("新增")
    public CommonResult<UserWhite> addUserWhite(@RequestBody UserWhiteRequest userWhiteRequest) {
    ...
    public CommonResult<List<UserWhite>> importUserWhite(@RequestBody List<UserWhiteExpress> userWhiteExpresses){
