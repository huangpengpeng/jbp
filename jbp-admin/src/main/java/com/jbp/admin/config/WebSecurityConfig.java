...
import com.jbp.admin.filter.JwtAuthenticationTokenFilter;
import com.jbp.admin.manager.AuthenticationEntryPointImpl;
import com.jbp.admin.manager.CustomAccessDeniedHandler;
import com.jbp.admin.manager.CustomAuthenticationProvider;
...
//            .antMatchers(HttpMethod.OPTIONS, "/**").permitAll()
				...
				.permitAll().antMatchers("/api/admin/merchant/login").permitAll()
				...
				.antMatchers("/common/download/resource**").anonymous().antMatchers("/doc.html").permitAll()
				...
				.antMatchers("/captcha/get", "/captcha/check").anonymous().antMatchers("/api/admin/payment/callback/**")
