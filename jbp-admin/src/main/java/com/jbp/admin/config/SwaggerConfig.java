...
public class SwaggerConfig {
    ...
    public Docket createRestApis() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                // 扫描的路径包
                .apis(RequestHandlerSelectors.basePackage("com.jbp.admin.controller.merchant"))
...
//                .globalOperationParameters(pars) // 针对单个url的验证 如果需要的话
    ...
    public Docket create2RestApis() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                // 扫描的路径包
                .apis(RequestHandlerSelectors.basePackage("com.jbp.admin.controller.platform"))
                // 指定路径处理PathSelectors.any()代表所有的路径
...
//                .globalOperationParameters(pars) // 针对单个url的验证 如果需要的话
    ...
    public Docket create3RestApis() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                // 扫描的路径包
                .apis(RequestHandlerSelectors.basePackage("com.jbp.admin.controller.publicly"))
                // 指定路径处理PathSelectors.any()代表所有的路径
