...
public class PlatformUserController {
    ...
    public CommonResult updateUser(@RequestBody @Validated PlatformUpdateUserRequest request) {
        userService.updateUser(request.getId(), request.getPwd(), request.getSex(), request.getRealName(), request.getPhone(), request.getCountry(), request.getProvince(), request.getCity(), request.getDistrict(), request.getAddress(), request.getPayPwd());
        return CommonResult.success();
    }
