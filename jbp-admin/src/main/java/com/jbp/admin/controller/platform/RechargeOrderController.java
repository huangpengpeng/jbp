...
public class RechargeOrderController {
    ...
    public CommonResult<CommonPage<RechargeOrder>> getList(@Validated RechargeOrderSearchRequest request, @Validated PageParamRequest pageParamRequest) {
        return CommonResult.success(CommonPage.restPage(rechargeOrderService.getAdminPage(request, pageParamRequest)));
    }
...
//        return CommonResult.success(rechargeOrderService.getBalanceList());
//    }
}
