...
import com.jbp.common.constants.YlyConstants;
import com.jbp.common.exception.CrmebException;
import com.jbp.common.model.admin.SystemAdmin;
import com.jbp.common.model.merchant.Merchant;
import com.jbp.common.model.merchant.MerchantPrint;
import com.jbp.common.model.order.MerchantOrder;
import com.jbp.common.model.order.OrderDetail;
import com.jbp.common.request.YlyPrintRequest;
import com.jbp.common.request.YlyPrintRequestGoods;
import com.jbp.common.response.YlyAccessTokenResponse;
import com.jbp.common.utils.CrmebDateUtil;
import com.jbp.common.utils.RedisUtil;
import com.jbp.common.utils.SecurityUtil;
import com.jbp.service.service.MerchantPrintService;
import com.jbp.service.service.MerchantService;
import com.jbp.service.service.OrderService;
import com.jbp.service.util.yly.RequestMethod;
...
//        logger.info("取消掉所有打印订单"+cancelAllPrint);
    ...
    public void printTicket(List<MerchantOrder> merchantOrderList, Integer op) {
        logger.info("小票打印参数：{}", JSON.toJSONString(merchantOrderList));
        logger.info("小票打印参数：op {}", op);
...
//                logger.info("小票打印：当前商户信息:{}", JSON.toJSONString(currentMerchantAdmin));
    ...
    public void ylyPrint(MerchantOrder order, MerchantPrint merchantPrint, Merchant merchant) {
        ...
        try {
            ...
            printSb.append("********************************");
            printSb.append("<FH>"+printFormatGoodsList(orderService.getDetailList(order.getOrderNo()))+"</FH>");
            printSb.append("********************************\n");
            printSb.append("<FH>");
            ...
            logger.info("易联云小票打印数据组装完毕:{}", printSb);
