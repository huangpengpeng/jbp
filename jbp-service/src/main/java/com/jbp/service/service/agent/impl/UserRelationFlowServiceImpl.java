...
public class UserRelationFlowServiceImpl extends ServiceImpl<UserRelationFlowDao, UserRelationFlow> implements UserRelationFlowService {
    ...
    public UserRelationGplotVo gplot(Integer uid,Integer uid0,Integer uid1,Map<Integer, User> uidMapList,Map<Integer, UserCapa> uidCapaMap) {
        ...
        RelationScore relationScore = relationScoreService.getByUser(uid,0);
        ...
        RelationScore relationScore2 = relationScoreService.getByUser(uid,1);
    ...
    @Override
    public UserRelationGplotVo gplotInfo(Integer uid,Integer level) {
        int lv = 0;

        if (level != null) {
            lv = level;
        }
        UserRelationGplotVo relation = new UserRelationGplotVo();
