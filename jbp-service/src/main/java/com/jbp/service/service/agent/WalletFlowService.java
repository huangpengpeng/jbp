...
public interface WalletFlowService extends IService<WalletFlow> {
    ...
    PageInfo<WalletFlowExtResponse> pageList(Integer uid, Integer type, String dateLimit, String externalNo, String action, String teamId, PageParamRequest pageParamRequest);
