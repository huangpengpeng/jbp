...
public interface CouponService extends IService<Coupon> {
     ...
     * @param limit 查询条数
     */
    List<Coupon> findProductDetailLimit(Integer proId, Integer merId, Integer limit);
     ...
     * @param minPrice 金额
     */
    List<Coupon> findByMerIdAndMoney(Integer merId, Integer proId, BigDecimal minPrice);
     ...
     * @param price 金额
     */
    List<Coupon> findPlatByMerIdAndMoney(Integer proId, List<Integer> proCategoryIdList, Integer merId, Integer brandId, BigDecimal price);
