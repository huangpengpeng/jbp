 ...
 */
@Component
public class CapaParallelDifferentialCommHandler extends AbstractProductCommHandler {
    ...
    public Integer getType() {
        return ProductCommEnum.等级平级级差佣金.getType();
    }
    ...
    public Boolean saveOrUpdate(ProductComm productComm) {
        ...
        if (!set.isEmpty() && set.size() > 1) {
            throw new CrmebException(ProductCommEnum.等级平级级差佣金.getName() + "类型不能同时存在金额和比例");
        }
        // 删除数据库的信息
    ...
    public static class Rule {
         ...
         * 平级一
         */
        private BigDecimal parallelRatioOne;
        /**
         * 平级二
         */
        private BigDecimal parallelRatioTwo;

        /**
         * 平级三
         */
        private BigDecimal parallelRatioThree;
