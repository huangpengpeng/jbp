 ...
 */
@Component
public class CapaXsDifferentialCommHandler extends AbstractProductCommHandler {
    ...
    public Integer getType() {
        return ProductCommEnum.星级级差佣金.getType();
    }
        ...
        userAmtMap.forEach((uid, amt) -> {
            ...
            if (ArithmeticUtils.gt(clearingFee, BigDecimal.ZERO)) {
                ...
                fundClearingService.create(uid, order.getOrderNo(), ProductCommEnum.星级级差佣金.getName(), clearingFee,
                        null, fundClearingProducts, orderUser.getAccount() + "下单获得" + ProductCommEnum.星级级差佣金.getName(), "");
