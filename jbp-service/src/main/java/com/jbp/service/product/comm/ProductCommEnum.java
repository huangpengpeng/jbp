...
public enum ProductCommEnum {
    ...
    白名单分组推三返一(31, "白名单分组推三返一", false,"（艾培生）每直接推荐一单设置分组推三返一的商品，根据分组不同商品推荐单数三单一循环获取商品推三返一的佣金"),
    白名单星级级差佣金(32, "白名单星级级差佣金", false,"根据白名单，根据下单人(不考虑下单人星级)往上找到指定星级用户根据配置比例进行分钱"),
    白名单级差伯乐佣金(33, "白名单级差伯乐佣金", true,"根据白名单，根据获得星级级差将的用户往上找指定等级规定人数按照配置的比例获得佣金"),
    ;
    /**
     * 佣金类型唯一
     */
