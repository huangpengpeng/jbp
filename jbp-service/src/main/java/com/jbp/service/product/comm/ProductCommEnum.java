...
public enum ProductCommEnum {
    ...
    升单极差(26, "升单等级极差", true,"按照第一个获取直推人的等级来获取级差"),
    感恩奖(27, "感恩奖", true,"根据所有已发佣金来计算，品牌会员；碰更高一级中间有平级、低一级的可分感恩奖。扣除10%,分给1个人10%,2个人各5%,三个人5%，3%，2%。"),
    线下补助(28, "线下补助", true,"根据下单时候用户填收货地址的数据，来匹配用户区域获取佣金"),
    等级平级级差佣金(29, "等级平级级差佣金", false,"根据下单人往上找到指定等级用户根据配置比例进行分钱，根据设置平级用户也可以分钱"),
    运营佣金(30, "运营佣金", false,"根据用户店铺身份获取最近的店铺根据配置的比例或者金额进行分佣"),
    ;
    /**
     * 佣金类型唯一
     */
