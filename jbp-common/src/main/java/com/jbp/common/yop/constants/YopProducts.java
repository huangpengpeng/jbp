...
public class  YopProducts {
    ...
    public static enum Merchant {
        ...
        小程序支付_微信_线下("MINI_PROGRAM_WECHAT_OFFLINE", "SINGLE_PERCENT", "0.6", "0.23"),
        小程序支付_支付宝_线下("MINI_PROGRAM_ALIPAY_OFFLINE", "SINGLE_PERCENT", "0.6", "0.23"),
        用户扫码_微信_线上("USER_SCAN_WECHAT_ONLINE", "SINGLE_PERCENT", "0.75", "0.63"),
        用户扫码_微信_线下("USER_SCAN_WECHAT_OFFLINE", "SINGLE_PERCENT", "0.6", "0.23"),
        用户扫码_支付宝_线下("USER_SCAN_ALIPAY_OFFLINE", "SINGLE_PERCENT", "0.6", "0.23"),
