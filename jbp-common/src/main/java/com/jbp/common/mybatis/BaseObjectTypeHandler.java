...
public class BaseObjectTypeHandler<T> extends BaseTypeHandler<Object> {
    ...
    public BaseObjectTypeHandler() {
        ...
        Type type = resolvableType.as(BaseObjectTypeHandler.class).getGeneric().getType();
    ...
    public void setNonNullParameter(PreparedStatement ps, int i, Object parameter, JdbcType jdbcType)
            throws SQLException {
        ps.setString(i, JacksonTool.toJsonString(parameter));
    }
