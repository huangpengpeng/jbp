...
public class UnifiedServiceImpl<M extends BaseMapper<T>, T> implements IService<T> {
    ...
    public boolean updateById(T entity) {
        Boolean success = retBool(baseMapper.updateById(entity));
        Assert.isTrue(success,"当前操作人数过多请稍后再试");
        return success;
    }

    @Override
    public boolean update(T entity, Wrapper<T> updateWrapper) {
        boolean success = retBool(baseMapper.update(entity, updateWrapper));
        Assert.isTrue(success,"当前操作人数过多请稍后再试");
        return success;
    }
