...
public class SysConfigConstants {
    ...
    public static final String CONFIG_LIANLIANWEIXIN_PAY_STATUS = "lianlian_weixin";
    public static final String CONFIG_LIANLIANALIPAY_PAY_STATUS = "lianlian_alipay";
