...
public class UserRechargeRequest implements Serializable {
    ...
    @StringContains(limitValues = {"weixin", "alipay", "lianlian","kq","jdAlipay","jdQuickPay"}, message = "未知的支付方式")
    ...
    @StringContains(limitValues = {"public", "mini", "h5", "wechatIos", "wechatAndroid", "alipay", "alipayApp", "lianlian","kq","jd"}, message = "未知的支付渠道")
